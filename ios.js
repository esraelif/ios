...
const ekranaHazirlik = (num) => {
    ...
    if (altEkranText === "0" && num !== '0' && num !== ".") {
        altEkranText = num
        return //Bu döngüden cık bu işini globaldeki degışkeni değistirerek bitirdi ama bir sey döndürmeyecek,daha önceki 0'ı da yok saycak
    }
